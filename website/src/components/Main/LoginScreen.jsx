          ...
          <div className="login-right">
            ...
            <div className="login-center">
              ...
              <div
                ...
                style={{ cursor: cookies.loginStage === "redirectGoogle" ? "progress" : "pointer" }}
              ...
              >
                ...
                <p className="login-google-p">{cookies.loginStage === "redirectGoogle" ? "Logowanie..." : "Zaloguj sie przez Google"}</p>
              </div>
