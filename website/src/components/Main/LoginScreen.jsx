        ...
        <div className="login-box" style={{ transform: `translateY(${yPos})` }}>
          ...
          <div className="login-right">
            ...
            <div className="login-center">
              ...
              <p className="text-text4 font-normal text-sm text-center p-2">lub</p>
              <div
                className="login-google-btn "
                style={{
                  cursor: cookies.loginStage?.startsWith('redirectGoogle') ? 'progress' : 'pointer',
                }}
              ...
              <p className="login-info">
                Logowanie się poprzez Google możliwe jest tylko z domeny @lo1.gliwice.pl (maila
                szkolnego)
              </p>
            </div>
            <p className="register-p">
              Nie masz konta?{' '}
              <a href="rejestracja" onClick={_handleRegister} className="register-a">
                Zarejestruj się!
              </a>
            </p>
          </div>
      ...
      >
        ...
        >
          ...
          <div className="login-center">
            ...
            <div className="login-google-btn" onClick={() => _handleLogin(false)}>
              <svg
                xmlns="http://www.w3.org/2000/svg"
                className="ionicon"
                height="26px"
