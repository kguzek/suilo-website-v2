...
import { logOut, AuthProvider, fetchWithToken, auth, DEBUG_MODE } from './firebase';
...
export default function App() {
  ...
  const [cookies, setCookies, removeCookies] = useCookies(['loginStage', 'userPerms']);
          ...
          >
            ...
            >
              <Route
                path=":postID"
                element={
                  <Post setPage={setPage} reload={shouldRefresh} setReload={setShouldRefresh} />
                }
              />
            </Route>
          </Route>
...
const Layout = ({ page, userInfo, loginAction, logoutAction, footerVisible, screenWidth }) => (
  <>
    {page !== 'voting' ? (
