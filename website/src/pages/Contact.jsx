    ...
    <div className="flex w-11/12 xl:w-10/12 flex-col justify-start min-h-[77.5vh] mt-20 align-top pb-10 m-auto">
      ...
      <div className="grid grid-cols-1 gap-7 md:gap-9 w-full lg:m-auto items-stretch lg:grid-cols-2  ">
        ...
        <div className="grid grid-cols-1 w-full sm:w-fit sm:m-auto sm:text-center lg:text-left lg:pt-10">
          <h3 className="text-text1 font-bold text-2xl md:text-3xl lg:text-[2rem]">
          ...
          <div className="flex flex-wrap max-w-full py-3 ">
            ...
            >
              <img src={GmailSVG} className="h-[1.5rem] md:h-[1.85rem]" alt="Gmail logo" />
              <p
                className="text-[1.1rem] md:text-[1.25rem] font-medium pl-4 md:pt-px"
                style={{ color: '#ff4c2b' }}
              >
                Email
              </p>
          ...
          <h4 className="font-medium text-[#1b1b1b] text-xl md:text-2xl mt-1 lg:mt-3">
          ...
          <p className="font-normal text-text1 mt-[.6rem] text-base not-italic md:text-[1.075rem]">
            Biblioteka - 3. piętro
          </p>
        </div>
      </div>
